            ...
            >
              <div className="flex items-center mb-6 pb-6 border-b border-purple-500/20">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Last updated: April 15, 2025</p>
                </div>
              </div>
              ...
              <div className="prose prose-invert max-w-none space-y-6">
                <section>
                  ...
                  <p className="text-gray-300">
                    This Privacy Policy describes how Trady.so ("we", "our", or "us") collects, uses, and shares your
                ...
                <section>
                  ...
                  <p className="text-gray-300 mt-2">
                    To exercise these rights, please contact us at privacy@trady.so. We will respond to your request
                ...
                <section>
                  ...
                  <p className="text-gray-300">
                    If you have any questions about this Privacy Policy, please contact us at privacy@trady.so.
                  </p>
                </section>
              </div>
            </motion.div>
