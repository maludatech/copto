      ...
      <div className="container relative mx-auto px-4 z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Experience professional-grade trading with advanced charts, multiple order types, and real-time market data.
          </p>

          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
            <Button
              onClick={scrollToTrading}
              className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-full px-8 py-6 shadow-glow-purple"
            >
              Start Trading Now
            </Button>
            <Link href="/features">
