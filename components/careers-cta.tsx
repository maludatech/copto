            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto">
                  We're looking for passionate individuals who want to make an impact in the crypto space. Join us in
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4">
                  ...
                  >
                    Learn About Our Culture <ArrowRight className="ml-2 h-4 w-4" />
                  </Button>
                </div>
              </div>
            </motion.div>
